...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/04 16:37:05 by rookuma           #+#    #+#             */
/*   Updated: 2025/05/04 18:02:33 by rookuma          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_gnl		gnl;
	static char	*save_l[1024];

	if (!check(fd, &gnl, &save_l[fd]))
		return (NULL);
...
// 	printf("== Reading from fd1, fd2, fd3 interleaved ==\n");
